...
public:
    ...
    void build( c_cs_player *pl, matrix_3x4 *bone_to_world, int mask, const vector_3d &origin, const vector_3d &angles, float time, const vector_3d &eye_angles );
};
...
inline bone_setup g_bone_setup = { };