...
void DrawBackgroundBlur( ImDrawList *drawList, IDirect3DDevice9 *device, int opacity = 255 ) {
    ...
    drawList->AddImageRounded( blurTexture, { 0.0f, 0.0f }, { backbufferWidth * 1.0f, backbufferHeight * 1.0f }, { 0.0f, 0.0f }, { 1.0f, 1.0f }, ImColor( 255, 255, 255, opacity ), 7.f );
}