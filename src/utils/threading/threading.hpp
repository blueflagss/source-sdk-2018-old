...
namespace threads
{
    ...
    inline thread_t create_thread( thread_fn_t start_addr, void *arg ) {
        ...
        static auto create_simple_thread = reinterpret_cast< create_simple_thread_t >( GetProcAddress( GetModuleHandleA( "tier0.dll" ), "CreateSimpleThread" ) );
    ...
    inline bool release_thread( thread_t thread ) {
        ...
        static auto release_thread_handle = reinterpret_cast< release_thread_handle_t >( GetProcAddress( GetModuleHandleA( "tier0.dll" ), "ReleaseThreadHandle" ) );
    ...
    inline bool join_thread( thread_t thread, unsigned timeout = 0xFFFFFFFF ) {
        ...
        static auto thread_join = reinterpret_cast< thread_join_t >( GetProcAddress( GetModuleHandleA( "tier0.dll" ), "ThreadJoin" ) );
