...
void crc_32::init( CRC32_t *pulCRC ) {
    *pulCRC = CRC32_INIT_VALUE;
}

void crc_32::final( CRC32_t *pulCRC ) {
    *pulCRC ^= CRC32_XOR_VALUE;
}

CRC32_t crc_32::get_table_entry( const unsigned int nSlot ) {
    return arrCRCLookupTable[ nSlot ];
}

void crc_32::process_buffer( CRC32_t *pulCRC, const void *pBuffer, int nBufferSize ) {
